...
class AIAgent:
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        # Use session_start (set once at init) for a stable timestamp that
        # doesn't change across compression cycles.  This keeps the system prompt
        # prefix-cache-friendly: the same session always produces the same tokens
        # up to this point, regardless of when compression happened.
    ...
    def _cap_delegate_task_calls(tool_calls: list) -> list:
        ...
        Uses the same configurable limit as delegate_task itself
        (delegation.max_concurrent_children in config.yaml, default 3).
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        if hasattr(self, "_is_qwen_portal") and self._is_qwen_portal():
