...
- **[Voice & TTS](tts.md)** — Text-to-speech output and voice message transcription across all messaging platforms, with provider options including Edge TTS, ElevenLabs, OpenAI TTS, qwen3-TTS, MiniMax, and NeuTTS.
